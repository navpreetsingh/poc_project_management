...
class ToDoListsControllerTest < ActionController::TestCase
  ...
  test "should create to_do_list" do
    assert_difference('ToDoList.count') do
      post :create, to_do_list: { content: @to_do_list.content, estimated_hours: @to_do_list.estimated_hours, priority: @to_do_list.priority, task_id: @to_do_list.task_id }
    end
  ...
  test "should update to_do_list" do
    patch :update, id: @to_do_list, to_do_list: { content: @to_do_list.content, estimated_hours: @to_do_list.estimated_hours, priority: @to_do_list.priority, task_id: @to_do_list.task_id }
    assert_redirected_to to_do_list_path(assigns(:to_do_list))
  end
