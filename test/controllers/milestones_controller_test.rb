...
class MilestonesControllerTest < ActionController::TestCase
  ...
  test "should create milestone" do
    assert_difference('Milestone.count') do
      post :create, milestone: { description: @milestone.description, end_date: @milestone.end_date, name: @milestone.name, start_date: @milestone.start_date, status: @milestone.status }
    end
  ...
  test "should update milestone" do
    patch :update, id: @milestone, milestone: { description: @milestone.description, end_date: @milestone.end_date, name: @milestone.name, start_date: @milestone.start_date, status: @milestone.status }
    assert_redirected_to milestone_path(assigns(:milestone))
  end
